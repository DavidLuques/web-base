...
////        double movimiento = magnitudVector(lectura.getAccelX(), lectura.getAccelY(), lectura.getAccelZ());
...
////            frecuencia, movimiento, rotacion,
////            limiteDormido, limiteReposo, limiteCaminando
////        );
////
...
////        int frecuencia, double movimiento, double rotacion,
////        int limiteDormido, int limiteReposo, int limiteCaminando
////    ) {
////        if (EstadoMascota.DURMIENDO.getComportamiento().coincideConLectura(frecuencia, movimiento, rotacion, limiteDormido))
////            return EstadoMascota.DURMIENDO;
////        if (EstadoMascota.REPOSO.getComportamiento().coincideConLectura(frecuencia, movimiento, rotacion, limiteReposo))
////            return EstadoMascota.REPOSO;
////        if (EstadoMascota.CAMINANDO.getComportamiento().coincideConLectura(frecuencia, movimiento, rotacion, limiteCaminando))
...
////            } else {
////                estadoFinal = Math.random() > PROBABILIDAD_MEDIA
...
//
//    @Override
//    public double calcularDistanciaEntreUbicaciones(Double lat1, Double lon1, Double lat2, Double lon2) {
//        double disLat = Math.toRadians(lat1 - lat2);
//        double disLon = Math.toRadians(lon1 - lon2);
//
//        double valorHaversine = Math.sin(disLat / 2) * Math.sin(disLat / 2)
//                 + Math.cos(Math.toRadians(lat1)) * Math.cos(Math.toRadians(lat2))
//                 * Math.sin(disLon / 2) * Math.sin(disLon / 2);
//
//        double distanciaAngular = 2 * Math.atan2(Math.sqrt(valorHaversine), Math.sqrt(1 - valorHaversine));
//
...
//        if (distanciaEnKm == null || distanciaEnKm == 0.0
//                || estado == null || pesoKg == null || pesoKg == 0.0) {
//            return 0.0;
//        }
//
