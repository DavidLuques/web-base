...
public class AnalizadorDeDatosServiceImplTest {
  ...
  public void dadaUnaMascotaConEstadoPrevioDistintoDebeAvanzarUnPasoHaciaElNuevoEstado() {
      ...
      lectura1.setAccelX(0.1); lectura1.setAccelY(0.1); lectura1.setAccelZ(0.1);
      lectura1.setGyroX(0.1);  lectura1.setGyroY(0.1);  lectura1.setGyroZ(0.1);
      ...
      lectura2.setAccelX(3.0); lectura2.setAccelY(3.0); lectura2.setAccelZ(3.0);
      lectura2.setGyroX(3.0);  lectura2.setGyroY(3.0);  lectura2.setGyroZ(3.0);
  ...
  public void cuandoSeLimpiaLaMemoriaLaSiguienteDeterminacionEsComoSinEstadoPrevio() {
      ...
      LecturaSensor lectura = new LecturaSensor();
      lectura.setFrecuenciaCardiaca(65);
      lectura.setAccelX(0.1); lectura.setAccelY(0.1); lectura.setAccelZ(0.1);
      lectura.setGyroX(0.1);  lectura.setGyroY(0.1);  lectura.setGyroZ(0.1);
  ...
  public void dadaUnaLecturaDeCorridaDebeDeducirEstadoCorriendo() {
      ...
      lectura.setAccelX(5.0); lectura.setAccelY(5.0); lectura.setAccelZ(5.0);
      lectura.setGyroX(5.0);  lectura.setGyroY(5.0);  lectura.setGyroZ(5.0);
